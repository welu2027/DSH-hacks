      ...
      <div className="mx-auto w-full max-w-7xl px-6 sm:px-8">
        ...
        <div className="mt-12 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
          {judges.map((judge, index) => (
            ...
            >
              <div className="flex-shrink-0 w-10 h-10 rounded-full bg-[#0ea5e9]/20 border border-[#0ea5e9]/40 flex items-center justify-center text-[#38bdf8] font-bold text-sm">
